...
from model_zoo import NodeEdgeAggregatorV2WithoutEdgeAggr as Model
...
def train(args):
    ...
    with mlflow.start_run():
        ...
        valid_loader = NeighborLoader(data, num_neighbors=[-1], batch_size=args.batch_size//4, directed=False, input_nodes=data.valid_nodes)
        test_loader = NeighborLoader(data, num_neighbors=[-1], batch_size=args.batch_size//4, directed=False, input_nodes=data.test_nodes)
