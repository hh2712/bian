...
class EdgeToNodeConv(MessagePassing):
    ...
    def forward(self, x: Tensor, hyperedge_index: Tensor,
        ...
        out = self.propagate(hyperedge_index.flip([0]), x=x.view(x.size(0), 1, x.size(1)), norm=D,
                             alpha=None, size=(num_edges, num_nodes))
