...
class Evaluator:
    ...
    def eval(self, y_true, y_pred):
        ...
        eval_dict = eval_dict | self._eval_rocauc(y_true, y_pred)
        eval_dict = eval_dict | self._eval_acc(y_true, y_pred)
        eval_dict = eval_dict | self._eval_prec(y_true, y_pred)
        eval_dict = eval_dict | self._eval_recall(y_true, y_pred)
        return eval_dict
    ...
    def _eval_prec(self, y_true, y_pred):
        y_pred = y_pred.argmax(axis=-1)
